...
public class CallableStatement06 {
    /*
 ...
 */
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        String sql1 = "CREATE OR REPLACE FUNCTION addfunction(x NUMERIC, y NUMERIC)\n" +
                "RETURNS NUMERIC\n" +
                "LANGUAGE plpgsql\n" +
                "AS\n" +
                "$$\n" +
        ...
        CallableStatement cst1 = con.prepareCall("{? = call addfunction(?, ?)}");
